...
public class HttpRequester {
	...
	public static String post(Request request,FormFile formFile) {
		...
		try {
            ...
            //协议头里有个boundary 是随机生成的字符串,用来分隔文本的开始和结束
		    ...
		    sb1.append(BOUNDARY);  
		    sb1.append(LINEND);  
		    sb1.append("Content-Disposition: form-data; name=\"" + formFile.inputStreamKey + "\"; filename=\"" + formFile.fileName + "\"" + LINEND);
	...
	public static String postArray(Request request,FormFile formFile) {
		...
		try {
			...
			for (int i = 0; i < formFile.inputStreamValueList.size(); i++) {
				InputStream inputStreamValue = formFile.inputStreamValueList.get(i);
				/**
				 * 下面是传图
				 */
				StringBuilder sb1 = new StringBuilder();  
