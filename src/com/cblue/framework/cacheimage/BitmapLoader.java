...
class BitmapLoader {
	...
	private ExecutorService executorService = Executors.newFixedThreadPool(Constants.MAX_THREADS);  //线程池
	...
	private int currentDownLoadState = DOWNLOAD_STATE_DONT_NEED_YET_OR_SUCESS;   //当前图片的下载状态
